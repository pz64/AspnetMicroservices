...
namespace Catalog.API.Repositories
{
    public class ProductRepository : IProductRepository
    {
        ...
        {
            FilterDefinition<Product> filterDefinition = Builders<Product>.Filter.ElemMatch(product => product.Category, categoryName);
        ...
        public async Task<IEnumerable<Product>> GetProductByName(string name)
        {
            ...
            FilterDefinition<Product> filterDefinition = Builders<Product>.Filter.ElemMatch(product => product.Name, name);
